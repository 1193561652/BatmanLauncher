...
import com.android.launcher3.pageindicators.PageIndicatorBatmanCaret;
...
public class Workspace extends PagedView
    ...
    public CellLayout insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        // created CellLayout.
        CellLayout newScreen = (CellLayout) LayoutInflater.from(getContext()).inflate(R.layout.workspace_screen, this, false /* attachToRoot */);
    ...
    protected void onPageEndTransition() {
        ...
        //((PageIndicatorLineCaret)mPageIndicator).hideAfterDelay();
        //((PageIndicatorBatmanCaret)mPageIndicator).hideAfterDelay();
    }
