...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                mTotalMotionX = 0;
                mActivePointerId = ev.getPointerId(0);  //第一个触控点，作为活动触控点
    ...
    protected void determineScrollingStart(MotionEvent ev, float touchSlopScale) {
        ...
        boolean xMoved = xDiff > touchSlop; //移动的距离足够大的时候，开始移动
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                final float x = ev.getX(pointerIndex);
                final float deltaX = mLastMotionX + mLastMotionXRemainder - x;  //需要移动的距离
        ...
        case MotionEvent.ACTION_UP:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                boolean isFling = mTotalMotionX > MIN_LENGTH_FOR_FLING && shouldFlingForVelocity(velocityX);
