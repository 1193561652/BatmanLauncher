...
public class Launcher extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsSafeModeEnabled = getPackageManager().isSafeMode();  //安全模式？
        mModel = app.setLauncher(this);     //设置启动器
        mModelWriter = mModel.getWriter(mDeviceProfile.isVerticalBarLayout());
        mIconCache = app.getIconCache();    //图标缓存
    ...
    public Bundle getActivityLaunchOptions(View v) {
        if (Utilities.ATLEAST_MARSHMALLOW) {
            ...
            //return ActivityOptions.makeScaleUpAnimation(v, left, top, width, height).toBundle();
