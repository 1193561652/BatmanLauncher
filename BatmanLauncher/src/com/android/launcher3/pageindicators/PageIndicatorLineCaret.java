...
public class PageIndicatorLineCaret extends PageIndicator {
    ...
    @Override
    protected void onFinishInflate() {  //当我们的XML布局被加载完后，就会回调onFinshInfalte这个方法，在这个方法中我们可以初始化控件和数据
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Log.v(TAG, "left:" +  lineLeft + " top:" +  (canvas.getHeight() - mLineHeight) + " right:" + lineRight);
    }
